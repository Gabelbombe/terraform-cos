...
variable "aws_ip_address_ranges" {
  description = "List of ip-ranges for accessing aws services (S3, EC2, ElastiCache, ..) in eu-west-1 see: http://docs.aws.amazon.com/general/latest/gr/aws-ip-ranges.html"
  type        = "list"
