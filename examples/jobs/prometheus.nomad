...
job "prometheus" {
  ...
  group "prometheus_group" {
    ...
    task "prometheus-server" {
      ...
      config {
        # AWS ECR playground:
        image = "<aws_account_id>.dkr.ecr.eu-west-1.amazonaws.com/service/prometheus:2018-04-29_18-47-3483d0b97_dirty"
      }
    ...
    task "prom-consul-exporter" {
      driver = "docker"
      config {
        image = "<aws_account_id>.dkr.ecr.eu-west-1.amazonaws.com/service/prom-consul-exporter:0.0.1"
        args = [
